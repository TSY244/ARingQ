...
#ifndef ARINGQUSEMAKEFILE_CREATETHREATPOOLWAITLOAD_H
#define ARINGQUSEMAKEFILE_CREATETHREATPOOLWAITLOAD_H
...
class __declspec(dllexport) MasterEncoderForCreateThreatPoolWaitLoader;

class MasterEncoderForCreateThreatPoolWaitLoader
{
public:
    static MasterEncoderForCreateThreatPoolWaitLoader* getInstance();
    MasterEncoderForCreateThreatPoolWaitLoader();
    ~MasterEncoderForCreateThreatPoolWaitLoader();
...
private:
    static MasterEncoderForCreateThreatPoolWaitLoader* _instance;
    static mutex _mtx;
...
#endif //ARINGQUSEMAKEFILE_CREATETHREATPOOLWAITLOAD_H
