...
#ifndef ARINGQUSEMAKEFILE_NTTESTALERTLOAD_H
#define ARINGQUSEMAKEFILE_NTTESTALERTLOAD_H
...
class __declspec(dllimport) MasterEncoderForNtTestAlertLoad;

class MasterEncoderForNtTestAlertLoad
{
public:
    static MasterEncoderForNtTestAlertLoad* getInstance();
    MasterEncoderForNtTestAlertLoad();
    ~MasterEncoderForNtTestAlertLoad();
...
private:
    static MasterEncoderForNtTestAlertLoad* _instance;
    static mutex _mtx;
...
#endif //ARINGQUSEMAKEFILE_NTTESTALERTLOAD_H
