...
#ifndef ARINGQUSEMAKEFILE_DYNAMICLOAD_H
#define ARINGQUSEMAKEFILE_DYNAMICLOAD_H
...
class __declspec(dllimport) MasterEncoderForDynamicLoader;

class MasterEncoderForDynamicLoader
{
public:
    static MasterEncoderForDynamicLoader* getInstance();
    MasterEncoderForDynamicLoader();
    ~MasterEncoderForDynamicLoader();
...
private:
    static MasterEncoderForDynamicLoader* _instance;
    static mutex _mtx;
...
#endif //ARINGQUSEMAKEFILE_DYNAMICLOAD_H
